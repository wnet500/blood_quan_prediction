...
from main.reference.torch_modeling_reference import CustomDataset, BloodQuanPredModel
...
class ModelTrainer:
  def __init__(
    ...
    self.ouput_dir = Path(__file__).parent.parent.parent.joinpath("output")
