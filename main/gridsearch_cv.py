...
from main.reference.utils import adjust_pred_value, get_adjusted_r2, get_95_conf_interval
...
class ParamGridSearch:
  ...
  def conduct_xgb_cv(self, grid_params: dict, tree_method: str = "gpu_hist", valid_size_in_trainval=1 / 8):
    start_time = datetime.now()
    gridsearch_results = []
